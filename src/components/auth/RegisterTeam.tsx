  ...
  return (
    <div className="py-2 flex justify-center items-center m-3">
      <div className="w-full max-xl:w-full container">
        <div>
          <h1 className="text-3xl font-semibold xl:mb-2 mb-4 w-full py-1  dark:text-white">
            Registro Escuadras
          </h1>
        </div>
        <form>
          ...
          <input
            className="w-full h-10 pl-5 pr-3 rounded-md mb-3 mt-1 bg-secondary-blue dark:bg-white/10 border-none focus:outline-none dark:text-white/50 placeholder:text-white/20"
            type="text"
          ...
          {loadingPaises ? (
            ...
            <select
              ...
              className="w-full h-10 pl-5 pr-3 rounded-md mb-3 mt-1 font-bold bg-secondary-blue dark:bg-white/30 border-none focus:outline-none dark:text-black/90 placeholder:dark:text-white/20"
            >
          ...
          <label>
            <p className="dark:text-white/80 font-medium">Ciclistas disponibles</p>
          </label>
          <div className="w-full max-h-60 overflow-y-auto mb-2 scrollbar-hide">
            {ciclistas
          ...
          <button
            className="w-full bg-primary-yellow hover:bg-secundary-yellow dark:bg-bg-green-secondary dark:hover:bg-[#3C5B6F] transition-all h-14 rounded-md dark:text-white font-medium mb-3 "
            type="button"
